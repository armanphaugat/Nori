...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    ...
    --border-focus: rgba(30,58,138,0.50);
    --text: #0f0f0f;
    --text-s: rgba(15,15,15,0.62);
    --text-m: rgba(15,15,15,0.38);
    --accent: #c41e1e;
    --accent-l: rgba(30,58,138,0.08);
    --accent-g: rgba(30,58,138,0.18);
    --accent-h: #a01515;
    --success: #1a7a4a;
    --success-bg: rgba(26,122,74,0.08);
    --danger: #c41e1e;
    --danger-bg: rgba(30,58,138,0.08);
    --warning: #b35c00;
  ...
  .typing-dot {
    ...
    background:rgba(30,58,138,0.4); display:inline-block;
