...
channel_router.add_api_route("/add-support-category",handle_get_channels,methods=["PUT"],dependencies=[Depends(require_guild_admin_query)],)
channel_router.add_api_route("/list",handle_get_channels,methods=["GET"],dependencies=[Depends(require_guild_admin_query)],)
channel_router.add_api_route("/add-support-category",handle_add_support_channel,methods=["PUT"],dependencies=[Depends(require_guild_admin_query)],)
